...
Hat man also den Ausdruck \enquote{X(\textbackslash d+)X}, also ein Ausdruck, der verlangt, dass die Zeichenkette mit einem \jv{X} beginnen muss, dann mindestens eine Ziffer hat und auf einem \jv{X} endet, und die Zeichenkette \enquote{X0135X}, dann kann man durch Zugriff auf die Gruppe die Zeichenkette \enquote{135} erhalten.
